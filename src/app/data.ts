...
export const services = [
  ...
  { 
    ...
    description: "Secure your family's future with our range of life insurance policies tailored to your needs." 
  },
  { 
    id: "investment-estate-planning", 
    title: "Investment & Estate Planning", 
    description: "We offer clear Investment & Estate Planning solutions for wealth creation, protection, and succession. Our services help individuals and businesses with goal-based investments, tax optimization, and seamless wealth transfers, ensuring long-term financial security and peace of mind." 
  },
  { 
    id: "claim-services", 
    title: "Claim Services", 
    description: "Streamlining the claim process for your peace of mind. In the unfortunate event of a loss, we guide you through every step." 
  },
  { 
    id: "commercial-insurance", 
    title: "Commercial Insurance", 
    description: "Comprehensive coverage for businesses—property, liability, and operational risks tailored for corporates and enterprises." 
  },
  { 
    id: "retail-insurance", 
    title: "Retail Insurance", 
    description: "Insurance solutions for individuals and small businesses, from motor and health to home and travel coverage." 
  },
  { 
    id: "group-employee-care", 
    title: "Group Employee Care", 
    description: "Group health and benefits plans for your workforce. Keep your employees protected with tailored group insurance solutions." 
  }
];
